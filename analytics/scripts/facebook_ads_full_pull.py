...
ACCOUNT = os.getenv("FB_AD_ACCOUNT_ID")     # e.g. act_9018283094917961
API_VER = os.getenv("FB_API_VER", "v23.0")  # default to v23.0
...
def main():
    ...
    # Pull ad-set-level metrics (aggregate)
