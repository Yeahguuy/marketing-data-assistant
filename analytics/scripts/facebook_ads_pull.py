...
ACCOUNT = os.environ.get("FB_AD_ACCOUNT_ID")         # e.g. act_9018283094917961
...
REQUIRED = {"FB_ACCESS_TOKEN": TOKEN, "FB_AD_ACCOUNT_ID": ACCOUNT}
...
while True:
    ...
    if not next_url:
        break
    # when using the next URL, clear params and follow the fully formed URL
    url, params = next_url, {}
    time.sleep(0.2)
